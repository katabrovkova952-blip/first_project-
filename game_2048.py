"""
2048 + порадник ходів (ЕКСПЕКТИМАКС) — версія під ЦІЛЬ: максимум балів до 2048.

За правилами твоєї гри 2048 — це ПЕРЕМОГА, і гра на ній закінчується.
Рейтинг рахується за балами в цю мить. Отже, стратегія не «зробити 2048
швидше» і не «ніколи не робити», а:
    відкладати злиття 2048 якомога довше, набиваючи поле високими плитками,
    і склеїти дві 1024 в 2048 аж тоді, коли поле вже нема куди покращувати.

Чому саме експектимакс: у 2048 два "гравці" — ти (обираєш напрямок, хочеш
максимум) і випадок (ставить 2 з 0.9 або 4 з 0.1). Проти випадку грають не
мінімаксом, а математичним сподіванням: у своїх вузлах беремо максимум,
у вузлах випадку — середнє, зважене на ймовірності.
"""
